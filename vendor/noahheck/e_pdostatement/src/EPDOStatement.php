...
class EPDOStatement extends PDOStatement implements LoggerAwareInterface
{
     ...
     */
    public function bindParam($param, &$value, $datatype = PDO::PARAM_STR, $length = 0, $driverOptions = false) : bool
    {
        $this->debug(
     ...
     */
    public function bindValue($param, $value, $datatype = PDO::PARAM_STR) : bool
    {
        $this->debug(
